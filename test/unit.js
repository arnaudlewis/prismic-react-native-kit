...
describe("Unit tests", function() {
  ...
  it('should init and render StructuredText', function () {
    ...
    var fragment = Prismic.Fragments.initField(null, structuredText);
  ...
  it('should init Timestamp without value', function () {
    assert.doesNotThrow(function() {
      var field = Prismic.Fragments.initField(null, {"type" : "Timestamp", "value" : null });
  ...
  it('should init Timestamp with valid date string', function () {
    ...
    var field = Prismic.Fragments.initField(null, {"type" : "Timestamp", "value" : dateString });
    assert.deepEqual(field, new Date(dateString));
  });
...
describe("HTML content", function() {
  ...
  it('2 spans on the same text - one bigger 1', function() {
    ...
    var html = Prismic.Fragments.insertSpans(null, text, spans, {});
...
it('Dates are well retrieved', function() {
  var timestampHtml = Prismic.Fragments.initField(null, {"type" : "Date", "value" : "2014-04-01"}).asHtml();
  assert.equal(
...
it('Timestamps are well retrieved', function() {
  var timestampHtml = Prismic.Fragments.initField(null, {"type" : "Timestamp", "value" : "2014-06-18T15:30:00+0000"}).asHtml();
  assert.equal(
