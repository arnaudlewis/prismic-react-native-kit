...
var MockMasks = require('./MockMasks');
...
Api.prototype = {
  ...
  getMasks: function(callback) {
    return new Promise((resolve, reject) => {
      //self.data.masks => url of the ressource to get all masks
      resolve(MockMasks())
    })
  },
   ...
   */
  response(documents){
    var results = documents.results.map(json => parseDoc(this.masks, json));
    return new Response(
      documents.page,
 ...
 * @returns {Document}
 */
var parseDoc = function(masks, json) {
  var fragments = {};
